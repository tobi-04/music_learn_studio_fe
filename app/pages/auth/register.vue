      ...
      <UCard>
        ...
        <UForm
          ...
          <div class="w-full">
            <UInput
              ...
              required
              class="w-full" />
            <p v-if="errors.name" class="text-sm opacity-80 mt-1">
              {{ errors.name }}
            </p>
          </div>
          ...
          <div class="w-full">
            ...
            <p v-else class="text-xs opacity-60 mt-1">
              Từ 3-50 ký tự, không khoảng trắng
            </p>
          </div>
          ...
          <div class="w-full">
            <UInput
              ...
              required
              class="w-full" />
            <p v-if="errors.email" class="text-sm opacity-80 mt-1">
              {{ errors.email }}
            </p>
          </div>
        ...
        <template #footer>
          <div class="text-center text-sm">
            <p>
              Đã có tài khoản?
              <NuxtLink to="/auth/login" class="font-semibold hover:underline">
                Đăng nhập ngay
              </NuxtLink>
            </p>
          </div>
